...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        createUserIfNotFound("alami@live.fr", "محمد", "العلمي", "1234", new ArrayList<Role>(Arrays.asList(adminRole)));
        createUserIfNotFound("hourri@yahoo.com", "يونس", "حوري", "1234", new ArrayList<Role>(Arrays.asList(userRole)));
